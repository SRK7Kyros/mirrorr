...
if (!command) {
  console.error("Usage: bun mobile/scripts/with-mobile-env.mjs <command>")
  process.exit(1)
}
...
const androidHome =
  process.env.ANDROID_HOME || process.env.ANDROID_SDK_ROOT || "/opt/homebrew/share/android-commandlinetools"
