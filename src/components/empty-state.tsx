...
export function EmptyState({ icon: Icon, text, height = "full", className, children }: EmptyStateProps) {
  return (
    <div className={cn("flex flex-col items-center justify-center text-muted-foreground", heightClass[height], className)}>
