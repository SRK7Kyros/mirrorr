...
export function MultiSelectProvider({ allIds, children }: MultiSelectProviderProps) {
  ...
  const idToIndex = useMemo(() => {
    ...
    allIds.forEach((id, i) => map.set(id, i))
    return map
  }, [allIds])
...
export function useMultiSelect() {
  ...
  if (!ctx) throw new Error("useMultiSelect must be used within a MultiSelectProvider")
  return ctx
}
