                            ...
                            >
                                ...
                                <div className="flex items-center gap-2 mt-1 text-[10px] text-muted-foreground/60">
                                    ...
                                    <span className="flex items-center gap-0.5">
                                        ...
                                        {resolvers.find(
                                            (r) => r.id === p.resolver_id,
                                        )?.name ?? `Resolver #${p.resolver_id}`}
                                    </span>
                                </div>
                            </SidebarEntry>
                        ))}
                ...
                <DetailHeader
                    ...
                    actions={
                        <div className="flex items-center gap-1">
                            <ExportButton
                                onExport={() =>
                                    importExportApi.exportProfile(profile.id)
                                }
        ...
        <CreatePanel
            ...
            onSubmit={() =>
                createMutation.mutate({
                    name,
                    default_engine_id: parseInt(config.engineId),
                    resolver_id: parseInt(config.resolverId),
